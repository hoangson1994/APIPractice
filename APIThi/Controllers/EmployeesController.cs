...
namespace APIThi.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class EmployeesController : ControllerBase
    {
        private readonly APIThiContext _context;

        public EmployeesController(APIThiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Search([FromQuery] string q)
        {
            ...
            var employee =  _context.Employee.Where(d=>d.Department.Contains(q));
